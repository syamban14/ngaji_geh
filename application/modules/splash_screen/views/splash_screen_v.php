...
<body class="bg-success">
    <div class="position-relative">
        <div class="d-flex align-items-center justify-content-center vh-100">
            <center>
                ...
                <h2 class="mb-0 text-white animate__animated animate__fadeIn">NGAJI GEH</h2>
            </center>
        </div>
        <div class="d-flex align-items-center justify-content-center position-absolute bottom-0 start-50 translate-middle-x mb-4">
            ...
            <span class="ms-2 text-white">Memuat...(1/2)</span>
        </div>
    </div>
    ...
    <script>
        new WOW().init();
        setTimeout(function() {
            window.location.href = '<?= base_url('splash_screen/b');?>';
        }, 3000);
    </script>
</body>
</html>